  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl px-4">
        ...
        >
          <div className="flex flex-1 items-center justify-center gap-3 rounded-2xl border border-border/80 bg-background/60 px-5 py-4 shadow-[0_12px_42px_-26px_rgb(15_23_42/0.5)] backdrop-blur-xl transition-[transform,box-shadow,border-color] duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] motion-safe:hover:-translate-y-1 hover:border-primary/20 hover:shadow-[0_20px_48px_-30px_rgb(15_23_42/0.45)] dark:border-white/12 dark:bg-white/[0.05] dark:shadow-[0_24px_50px_-34px_rgb(0_0_0/0.7)] dark:hover:border-primary/25 dark:hover:shadow-[0_28px_56px_-36px_rgb(0_0_0/0.65)]">
          ...
          {TESTIMONIALS.map((t, index) => (
            <article
              ...
              className={cn(
                ...
                visible && reduceMotion && 'transition-[opacity,transform] duration-700 ease-out'
              )}
              style={
            ...
            >
              <div
                className={cn(
                  'relative flex h-full flex-col overflow-hidden rounded-2xl border border-border/80 bg-gradient-to-br from-background/95 via-background/90 to-muted/45 p-6 shadow-[0_1px_0_0_rgb(255_255_255/0.07)_inset,0_18px_48px_-36px_rgb(15_23_42/0.4)] backdrop-blur-xl md:p-7',
                  'dark:from-white/[0.07] dark:via-white/[0.045] dark:to-white/[0.02] dark:border-white/12 dark:shadow-[0_1px_0_0_rgb(255_255_255/0.06)_inset,0_24px_60px_-40px_rgb(0_0_0/0.75)]',
                  'ring-1 ring-transparent transition-[transform,box-shadow,border-color,ring-color] duration-500 ease-[cubic-bezier(0.22,1,0.36,1)]',
                  'motion-safe:hover:-translate-y-2 motion-reduce:hover:translate-y-0',
                  'hover:border-primary/25 hover:shadow-[0_1px_0_0_rgb(255_255_255/0.1)_inset,0_28px_64px_-32px_rgb(59_130_246/0.18)]',
                  'hover:ring-primary/15 dark:hover:border-primary/35 dark:hover:shadow-[0_1px_0_0_rgb(255_255_255/0.09)_inset,0_32px_72px_-36px_rgb(99_102_241/0.22)]'
                )}
              >
                <div
                ...
                <Quote
                  className="mb-4 size-7 text-muted-foreground/35 transition-colors duration-500 ease-out group-hover:text-primary/55 md:size-8"
                  aria-hidden
                />
                ...
                <footer className="mt-auto flex items-center gap-3 border-border/55 border-t border-dashed pt-5 dark:border-white/12">
                  <div
                    className="relative flex size-11 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-primary/22 to-chart-4/14 font-semibold text-primary text-[0.6875rem] leading-none shadow-inner ring-1 ring-white/20 transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:scale-105 dark:ring-white/10"
                    aria-hidden
                  >
                    {t.initials}
                  </div>
